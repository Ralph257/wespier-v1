                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.schedule.update',$schedule->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="lawyer" id="lawyer" class="form-control selectoption select2">
                                        ...
                                        <option {{ $schedule->lawyer_id==$item->id? 'selected' : ''}} value="{{ $item->id }}">{{ @$item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="agent">{{ $website_lang->where('lang_key','agent')->first()->custom_lang }}</label>
                                    <select name="agent" id="agent" class="form-control selectoption select2">
                                        <option value="">{{ $website_lang->where('lang_key','select_agent')->first()->custom_lang }}</option>
                                        @foreach ($agents as $item)
                                        <option {{ $schedule->agent_id==$item->id? 'selected' : ''}} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="day" id="day" class="form-control selectoption">
                                        ...
                                        <option {{ $schedule->day_id==$item->id? 'selected' : ''}} value="{{ $item->id }}">{{ $item->day }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control selectoption">
                                        <option {{ $schedule->status==1 ? 'selected' :'' }} value="1">{{ $website_lang->where('lang_key','active')->first()->custom_lang }}</option>
                                        <option {{ $schedule->status==0 ? 'selected' :'' }} value="0">{{ $website_lang->where('lang_key','inactive')->first()->custom_lang }}</option>
                                    </select>
                                </div>
                            </div>
