                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                @endphp
                                <td>{{ $name }}</td>
                                <td>{{ $website_lang->where('lang_key','agent_name')->first()->custom_lang }}</td>
                            </tr>
                            <tr>
                                @php
                                    $agent_email="{{email}}";
                                @endphp
                                <td>{{ $agent_email }}</td>
                                <td>{{ $website_lang->where('lang_key','agent_email')->first()->custom_lang }}</td>
                            </tr>
                            <tr>
                                @php
                                    $password="{{password}}";
                                @endphp
                                <td>{{ $password }}</td>
                                <td>{{ $website_lang->where('lang_key','agent_pass')->first()->custom_lang }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
