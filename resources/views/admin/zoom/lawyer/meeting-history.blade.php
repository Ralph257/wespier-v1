...
@section('admin-content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h4 class="m-0 font-weight-bold text-primary">{{ $website_lang->where('lang_key','upcoming_meeting_lawyer')->first()->custom_lang }}</h4>
            <hr>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h4 class="m-0 font-weight-bold text-primary">{{ $website_lang->where('lang_key','previous_meeting_lawyer')->first()->custom_lang }}</h4>
            <hr>
            <div class="table-responsive">
