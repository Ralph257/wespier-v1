                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('agent.meet',$item->id) }}"  class="btn btn-primary btn-sm">{{ $website_lang->where('lang_key','meet')->first()->custom_lang }}</a>
                            </td>
                        </tr>
                        @endforeach
    ...
    "use strict";
         ...
         $(document).on('click', '#searchDoctorSchedule', function () {
            ...
            if(schedule_id){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('agent.search.appointment') }}",
                    data:{'schedule_id':schedule_id,'agent_id':agent_id},
